...
export const ConfigurationPanel: React.FC<ConfigurationPanelProps> = ({
  ...
  const carScenarioOptions = [
    { count: 0, label: '🎲 Random', desc: 'Mỗi luồng ngẫu nhiên 8 đến 16 xe độc bản', badge: '8 - 16 Xe' },
    ...
    { count: 60, label: '60 Xe', desc: 'Siêu đại chiến 60 tay đua huyền thoại cùng lúc', badge: 'Mega 60' }
  ];
